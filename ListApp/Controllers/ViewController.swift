...
//  ListApp
//
//  Created by Mert Öktem on 5.03.2024.
...
class ViewController: UIViewController {
    ...
    @IBAction func didRemoveBarButtonItemTapped(_ sender: UIBarButtonItem) {
        presentAlert(title: "Uyarı",
            ...
            let managedObjectContext = appDelegate?.persistentContainer.viewContext; for object in self.data { managedObjectContext!.delete(object) }; try?managedObjectContext?.save(); self.fetch()
    ...
    func presentAddAlert() {
        ...
        presentAlert(title: "Yeni Eleman Ekle",
            ...
            if text != "" {
                ...
                self.presentWarninAlert()
            }
        })
    }
    
    func presentWarninAlert() {
        presentAlert(title: "Uyarı!",
